...
//  SwiftyNinja
//
//  Created by Juan Ramírez Blancas on 22/05/24.
//
...
class GameScene: SKScene {
    ...
    func createGameOverScreen() {
        ...
        restartGame.position = CGPoint(x: 512, y: 300)
